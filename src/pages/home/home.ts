...
//    ExpectedResult = 1.1;
//    mortality = NELAPage.calcNELA(TestData).mortality;
...
//    morbidity = PPOSSUMPage.ppcalc(TestData).morbidity;
//    mortality = PPOSSUMPage.ppcalc(TestData).mortality;

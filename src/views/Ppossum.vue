  ...
  <ion-card><ion-card-content>
        ...
        <ion-card><ion-card-content>
            <div class="item item-divider item-text-wrap"><strong>Sodium (mmol.L<sup>-1</sup>)</strong></div>
                ...
                <ion-item><ion-label text-wrap>&ge;136 mmol/l</ion-label><ion-radio value=1 slot="start"></ion-radio></ion-item>
                <ion-item><ion-label text-wrap>131 - 135 mmol/l</ion-label><ion-radio value=2 slot="start"></ion-radio></ion-item>
                <ion-item><ion-label text-wrap>126 - 130 mmol/l</ion-label><ion-radio value=4 slot="start"></ion-radio></ion-item>
                <ion-item><ion-label text-wrap>&le;125 mmol/l</ion-label><ion-radio value=8 slot="start"></ion-radio></ion-item>
                </ion-radio-group>
                </ion-list>
</ion-card-content></ion-card>
        <ion-card><ion-card-content>
